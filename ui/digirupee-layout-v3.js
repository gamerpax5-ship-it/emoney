(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      body.digi-layout-v5{margin:0!important;padding:0!important;--digi-safe-top:env(safe-area-inset-top,0px);--digi-safe-bottom:env(safe-area-inset-bottom,0px)}
      body.digi-layout-v5.digi-legacy-insets{--digi-safe-top:max(24px,env(safe-area-inset-top,0px))}
      body.digi-layout-v5.digi-legacy-insets .app{padding-top:0!important}
      body.digi-layout-v5 .app{width:min(430px,100%)!important;height:100vh!important;height:100dvh!important;min-height:0!important;max-height:none!important;grid-template-rows:calc(68px + var(--digi-safe-top)) minmax(0,1fr) calc(var(--nav) + var(--digi-safe-bottom))!important;overflow:hidden!important;margin:0 auto!important}
      body.digi-layout-v5 .statusbar{display:none!important}
      body.digi-layout-v5 .header{grid-row:1!important;height:calc(68px + var(--digi-safe-top))!important;padding:calc(10px + var(--digi-safe-top)) 15px 9px!important;min-height:0!important;box-sizing:border-box!important;background:#050607!important}
      body.digi-layout-v5 .header-copy{min-width:0}
      body.digi-layout-v5 .header-copy h1{font-size:25px!important;line-height:1.08!important}
      body.digi-layout-v5 .header-copy p{font-size:10.5px!important;line-height:1.3!important}
      body.digi-layout-v5 .page{grid-row:2!important;padding:0 15px calc(14px + var(--digi-safe-bottom))!important;min-height:0!important;box-sizing:border-box!important;overscroll-behavior:contain}
      body.digi-layout-v5 .app>.nav{grid-row:3!important;position:static!important;width:100%!important;height:calc(var(--nav) + var(--digi-safe-bottom))!important;padding:5px 8px calc(6px + var(--digi-safe-bottom))!important;box-sizing:border-box!important}
      body.digi-layout-v5 .app>.nav .nav-icon{width:30px!important;height:30px!important}
      body.digi-layout-v5 #sell .block-head{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:8px}
      body.digi-layout-v5 #sell .block-head>div{min-width:0}
      body.digi-layout-v5 #sell .block-head .small-add{flex:none;min-height:31px;padding:0 9px;font-size:8.5px}
      ...
      .digi-route-compact{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;justify-content:space-between;gap:10px;padding:10px 11px;border:1px solid #292e36;border-radius:12px;background:#0d0f12;margin-bottom:10px}
      .digi-route-copy{min-width:0;overflow:hidden}.digi-route-copy b{display:block;font-size:11px;line-height:1.2}.digi-route-copy small{display:block;margin-top:3px;color:#858b93;font-size:8.3px;line-height:1.35;white-space:normal;overflow-wrap:anywhere}
      .digi-route-side{display:flex;align-items:center;justify-content:flex-end;gap:7px;flex:none;flex-wrap:wrap}
      ...
      #profile .section:has(+ .profile-method-list){margin-top:12px;margin-bottom:6px;min-height:30px}
      #profile .method-toolbar{gap:5px}
      #profile .method-toolbar .manage-btn,#profile .method-toolbar button{min-height:30px!important;padding:0 8px!important;font-size:8.5px!important}
      #profile .profile-method-list{gap:6px;margin-top:-2px}
      #profile .profile-method-row{grid-template-columns:minmax(0,1fr) 36px;gap:8px;padding:8px 9px;border-radius:10px;min-height:0}
      #profile .profile-method-copy{min-width:0;line-height:1.2}
      #profile .profile-method-copy b{font-size:10.8px;line-height:1.2}
      #profile .profile-method-copy small{font-size:8.9px;line-height:1.25;margin-top:2px}
      #profile .profile-method-copy span{font-size:8.3px;line-height:1.25;margin-top:3px}
      ...
      @media(max-width:370px){.digi-rail-strip{grid-template-columns:1fr 1fr}.digi-mini-stat:last-child{grid-column:1/-1}.digi-deposit-body{grid-template-columns:82px minmax(0,1fr)}.digi-channel-qr{width:82px;height:82px}.digi-plan-row{grid-template-columns:1fr}.digi-deposit-meta{grid-template-columns:1fr 1fr}.digi-deposit-meta>div:last-child{grid-column:1/-1}.digi-route-compact{grid-template-columns:1fr;gap:8px;padding:9px 10px}.digi-route-side{width:100%;justify-content:flex-start}.digi-route-side .digi-route-state{margin-right:auto}.digi-route-compact .ghost-btn{min-width:72px}}
    `;
  ...
  function install() {
    ...
    const nativeInsetsApplied = /digiRupeeInsets\/1(?:\s|$)/i.test(ua);
    const androidWebView = /android/i.test(ua) && /(?:\bwv\b|;\s*wv\)|digiRupee\/)/i.test(ua);
    document.body.classList.toggle('digi-legacy-insets', androidWebView && !nativeInsetsApplied);
    configureNav();
    ensureSellExtensions();
    customizeHome();
    enhanceProfile();
