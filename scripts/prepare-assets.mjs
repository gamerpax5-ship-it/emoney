...
function productionHtml(source) {
  ...
  html = html.replace(/<head>/i, '<head><script>document.documentElement.classList.add("digi-booting");document.documentElement.classList.remove("digi-ready");</script><style id="digi-boot-guard">html,body{background:#050607!important}html.digi-booting .app{visibility:hidden!important;opacity:0!important;pointer-events:none!important}html.digi-booting::before{content:"digiRupee";position:fixed;inset:0;z-index:2147483647;display:grid;place-items:center;background:#050607;color:#f1cf67;font:800 22px system-ui,-apple-system,"Segoe UI",sans-serif;letter-spacing:-.02em}html:not(.digi-booting)::before{display:none!important}html:not(.digi-booting) .app{visibility:visible!important;opacity:1!important;pointer-events:auto!important}</style>');
