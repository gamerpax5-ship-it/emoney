...
const canonicalLayoutBankFixJs = join(root, 'ui/digirupee-layout-v6-bankfix.js');
...
function productionHtml(source) {
  ...
  html = html.replace(/<\/body>/i, '<script src="/digirupee-qr.js" defer></script><script src="/digirupee-app.js" defer></script><script src="/digirupee-rewards-assets.js" defer></script><script src="/digirupee-rewards.js" defer></script><script src="/digirupee-layout-v3.js" defer></script><script src="/digirupee-layout-v6-bankfix.js" defer></script></body>');
  return html;
}
...
async function rebuildAndroid() {
  ...
  const hostedLayoutBankFixJs = join(root, 'website/digirupee-layout-v6-bankfix.js');
  ...
  await copyFile(canonicalLayoutBankFixJs, hostedLayoutBankFixJs);
  ...
  return { hostedHtml, hostedJs, hostedQrJs, hostedRewardsJs, hostedRewardsAssetsJs, hostedLayoutJs, hostedLayoutBankFixJs, fallback, webAppUrl, bytes: Buffer.byteLength(sourceHtml) };
}
