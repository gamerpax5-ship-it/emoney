...
function productionHtml(source) {
  ...
  html = html.replace(/<\/body>/i, '<script src="/digirupee-qr.js" defer></script><script src="/digirupee-app.js" defer></script><script src="/digirupee-rewards-assets.js" defer></script><script src="/digirupee-rewards.js" defer></script><script src="/digirupee-layout-v3.js" defer></script></body>');
  return html;
}
